      ...
      <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;margin:0 auto;background:#ffffff;border-collapse:collapse;border-radius:18px;overflow:hidden;box-shadow:0 12px 36px rgba(15,74,42,.12);">
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="margin:28px 0 0;font-size:14px;line-height:1.7;color:#607466;">Conservez cet email. Pour toute question : <a href="mailto:assistante_event@differencegroup.info" style="color:#0a6338;font-weight:700;">assistante_event@differencegroup.info</a><br />+225 27 22 30 83 48<br />+225 05 02 87 67 05<br />+225 05 65 17 36 63<br />+225 07 47 51 61 62</p>
          </td>
        </tr>
